    ...
    public class AddStoryActivity : BaseActivity
    {
        ...
        private void SetVideoStory(string url)
        {
            try
            {
                ...
                PlayIconVideo.Tag = "Play";
                PlayIconVideo.SetImageResource(Resource.Drawable.ic_video_players);
                    ...
                    case "Play":
                        {
                            ...
                            PlayIconVideo.SetImageResource(Resource.Drawable.icon_pause_vector);
                            PlayIconVideo.ImageTintList = ColorStateList.ValueOf(Color.White);
                            break;
                        }
                    default:
                        {
